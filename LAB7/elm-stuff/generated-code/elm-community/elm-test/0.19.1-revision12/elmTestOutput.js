	...
	if (!l.b) {
		...
		var withX = A2(
			...
			function (combination) {
				return A2($elm$core$List$cons, x, combination);
			},
			withoutX);
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['D:\\PF\\LAB7\\tests\\VerifyExamples\\Documentation\\Combinations0.elm', 'D:\\PF\\LAB7\\tests\\VerifyExamples\\Documentation\\Combinations1.elm', 'D:\\PF\\LAB7\\tests\\VerifyExamples\\Documentation\\Tails0.elm']),
		processes: 8,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-19636-1";
var net = require('net'),
