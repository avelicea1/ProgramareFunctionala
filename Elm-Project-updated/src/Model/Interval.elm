...
view interval =
    let
        ...
        getLength intL = 
          case length intL of
             Just (a, b) -> 
                 [text ((String.fromInt a) ++ " years and  " ++ (String.fromInt b) ++ " months ")]           
             Nothing -> [text "", text ""]
    in
    
     div [ class "interval" ]
        [ p [ class "interval-start" ] [ text "Start: ", Date.view interval1.start ]
        , p [ class "interval-end" ] [ text "End: ", maybeDateView interval1.end ]
