...
intermediary :: Int -> Parser String 
intermediary val = P.char ':' `pThen` P.with (P.take val) P.succeed
string :: Parser String
string = P.with P.number intermediary
...
dict = P.between (P.char 'd') (P.char 'e') (P.many val)
  where 
    val = P.andThen string value
