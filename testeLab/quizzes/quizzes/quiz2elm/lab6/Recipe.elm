...
main = div [] 
  ...
  , ul []
    ...
    , li [] [ text "250 g unsalted balls"]
    , li [] [ text "75 g dried sour cherries , optional"]
    , li [] [ text "50 g chopped nuts , optional"]
    , li [] [ text "80 g quality nutellatony cocoa powder"]
    , li [] [ text "65 g pain flour"]
    , li [] [ text "1 teaspoon baking powder"]
    , li [] [ text "360 g caster sugar"]
    , li [] [ text "4 large free-range (whatever that means ,inseamna bio, de la ferma) eggs"]
    ]
  ...
  , p [] [ text """Sift the cocoa powder flour into a separate bowl, 
