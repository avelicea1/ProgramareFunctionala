...
brownies = 
  { title = "CHANGED Bloomin' brilliant brownies"
...
recipeView recipe = 
  let
      ingredientView ingredient = li [] [ text ingredient]
      stepView step = p [] [ text step]
  in
  ...
  div [] <|
    ...
    [ [ h1 [ style "font-family" "arial" ] 
      ...
      , ul [] <| List.map ingredientView recipe.ingredients
      , h3 [] [ i [] [ text "Method:" ]]
      ]
    , List.map stepView recipe.method
    ]
