	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Link to Original Recipe:')
					])),
				A2(
				$elm$html$Html$a,
				_List_fromArray(
				...
				_List_fromArray(
					[
						$elm$html$Html$text(recipe.linkToOriginal)
					]))
			]));
};
...
var $author$project$RecipeTests$atLeastOneIngredient = $elm_explorations$test$Test$skip(
	A2(
...
var $author$project$RecipeTests$atLeastOneIngredientClass = $elm_explorations$test$Test$skip(
	A2(
		$elm_explorations$test$Test$test,
...
var $author$project$Counter$view = function (model) {
	var textColor = ((model > 8) || (_Utils_cmp(model, -8) < 0)) ? A2($elm$html$Html$Attributes$style, 'color', 'red') : A2($elm$html$Html$Attributes$style, 'color', 'black');
	...
	function (_v0) {
		return A2(
			...
			A2(
				...
				$elm_explorations$test$Test$Html$Query$fromHtml(
					$author$project$Counter$view(10))));
	});
...
var $author$project$CoinFlipTests$initialViewTest = A2(
	$elm_explorations$test$Test$test,
	'view contains the following test \"Press the flip button to get started\"',
	function (_v0) {
		return A2(
			$elm_explorations$test$Test$Html$Query$has,
			_List_fromArray(
...
var $author$project$Test$Generated$Main$main = A2(
	$author$project$Test$Runner$Node$run,
	{
		...
		paths: _List_fromArray(
			['D:\\PF\\LAB6\\tests\\CoinFlipTests.elm', 'D:\\PF\\LAB6\\tests\\CounterTests.elm', 'D:\\PF\\LAB6\\tests\\RecipeTests.elm']),
		processes: 8,
...
var pipeFilename = "\\\\.\\pipe\\elm_test-10608-1";
var net = require('net'),
