  ...
  describe "Exercises module"
    ...
    , describe "Exercises.changePreferenceToDarkTheme"
      [ test "First example" <|
       ...
       ,test "Change preference to Dark theme" <|
            \() ->
                let
                    config1 = AccountConfiguration Theme.Light True False
                    config2 = AccountConfiguration Theme.Dark True False
                    config3 = AccountConfiguration Theme.Dark False False
                    config4 = AccountConfiguration Theme.Dark False True
                in
                Expect.equal
                    [config2, config2, config3, config4]
                    (changePreferenceToDarkTheme [config1, config2, config3, config4])
          ]
    ]
